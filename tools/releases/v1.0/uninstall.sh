...
zenity --question --text="Are you sure you would like to uninstall Backboard $version?"
if ! [[ "$?" == "0" ]];
then
...
zenity --info --text="Uninstalling Backboard $version..."
...
zenity --info --text="Finished uninstalling Backboard $version!"
