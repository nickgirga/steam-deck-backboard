...
zenity --question --ellipsize --text="Are you sure you would like to uninstall Backboard?"
if ! [[ "$?" == "0" ]];
then
...
zenity --info --ellipsize --text="Uninstalling Backboard..."
...
zenity --info --ellipsize --text="Finished uninstalling Backboard!"
